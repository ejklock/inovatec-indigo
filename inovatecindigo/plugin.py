...
for path in itertools.chain(
    glob(
        os.path.join(str(importlib_resources.files("inovatecindigo") / "components"), "*")
    ),
    glob(os.path.join(str(importlib_resources.files("inovatecindigo") / "patches"), "*")),
):
